# c:\Users\mshas\OneDrive\Desktop\SUNDAY\permission_manager.py
"""
Permission Manager for SUNDAY (Text-First Mode).
Handles authorization requests via terminal console input, completely bypassing
the microphone and transcription layers.
"""
from voice_output import speak

class PermissionManager:
    def __init__(self):
        # AudioManager is completely removed from the constructor
        pass
